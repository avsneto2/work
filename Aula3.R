...
##Arquivo txt
#header = FALSE
arquivo.texto <-read.table('emotion.txt', sep = "\t")
#header = TRUE
arquivo.texto <-read.table('Users/otto.tavares/Documents/Infnet/emotion.txt',header = TRUE ,  sep = "\t")
##Arquivo csv
tomato <- read.csv("TomatoFirst.csv", sep = ",")
