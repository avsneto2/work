...
### `{r Correlacao de variaveis , echo = TRUE} ### kable(cor(Bevolucao.roubos.f5.tbl %>% dplyr::filter(!is.na(apreensao_drogas_sum)) %>%  ### dplyr::select(apreensao_drogas_sum, roubo_transeunte_sum,roubo_celular_sum,roubo_residencia_sum))) ###`
